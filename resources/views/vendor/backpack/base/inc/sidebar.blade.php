    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
              <a href="#"><i class="fa fa-university"></i> <span>Church</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="{{ backpack_url('department') }}"><i class="fa fa-bars"></i> <span>Departments</span></a></li>
                <li><a href="{{ backpack_url('testimony') }}"><i class="fa fa-user-secret"></i> <span>Testimonies</span></a></li>
                <li><a href="{{ backpack_url('member') }}"><i class="fa fa-users"></i> <span>Members</span></a></li>
                <li><a href="{{ backpack_url('leader') }}"><i class="fa fa-user"></i> <span>Leaders</span></a></li>
          ...
          <li class="treeview">
              <a href="#"><i class="fa fa-headphones"></i> <span>Sermons</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="{{ backpack_url('sermoncategory') }}"><i class="fa fa-volume-up"></i> <span>Category</span></a></li>
                <li><a href="{{ backpack_url('sermon') }}"><i class="fa fa-headphones"></i> <span>Sermons</span></a></li>
              </ul>
          </li>
          ...
          <li><a href="{{ backpack_url('feedback') }}"><i class="fa fa-comments"></i> <span>Feedback</span></a></li>
